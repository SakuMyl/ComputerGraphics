...
Hours spent on extra credit (approx.): 1,5
...
SSD on the GPU (the easy recommended exercise)
...
Would be good to add some comments above the ssd_prog to explain why there are two vec4 vectors for both the joints and the weights. This confused me a bit.
Great assigment otherwise!
